...
- 시드 데모 페르소나는 `user_id = 1` (카드 5건, 거래 361건) — V900이 카드 5건·거래 355건,
  V901이 혜택 추천 시연용으로 카드 4건·거래 36건을 더하고, **V904가 그 카드 4건을 소프트 삭제하고
  거래 30건을 지운다**(V901이 `user_card 3`에 더한 6건은 남는다)
