...
class CardMonthlyBenefitPeriodResolverTest {
    ...
    @Test
    void 이번달은_오늘까지_포함하고_전월은_전체기간으로_계산한다() {
        ...
        assertThat(period.getAsOfDate()).isEqualTo(LocalDate.of(2026, 7, 24));
        assertThat(period.getBenefitStartAt()).isEqualTo(LocalDateTime.of(2026, 7, 1, 0, 0));
        assertThat(period.getBenefitEndAt()).isEqualTo(LocalDateTime.of(2026, 7, 25, 0, 0));
